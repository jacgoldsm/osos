...
jp = three._data.dropna(subset='col').merge(four._data.dropna(subset='col'), on=['col'], how='inner')
kp = three._data.merge(four._data.dropna(subset='col'), on=['col'], how='left')
lp_notnull = three._data.dropna(subset='col').merge(four._data.dropna(subset='col'), on=['col'], how='outer')
